...
% Copyright (c) 1998-2016 by Tomlab Optimization Inc., $Release: 8.2.0$
% Written May 18, 1998.   Last modified Jan 18, 2016. 
...
Prob = struct('TOMLAB','v8.2','MATLAB',[y,z], 'Threads', double(1), 'A', [], ...
